        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post" enctype="multipart/form-data" action="../admin/book_add.action">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <div class="row">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="col-md-4">
                                                <input type="text" name="book.productName" id="productName" class="form-control"/>
                                            </td>
                                            <td class="col-md-3">
                                                <input type="text" name="book.author" id="authortName" class="form-control"/>
                                            </td>
                                            <td class="col-md-2">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <input type="text" name="wordNumer" id="wordNum" class="form-control"/>
                                                    </div>
                                                    <div class="col-md-1 col-md-pull-1" style="padding-top: 6px">万</div>
                                                </div>
                                            </td>
                                            <td class="col-md-1">
                                                <input type="number" name="book.totalPage" id="pageNum" class="form-control"/>
                                            </td>
                                            <td class="col-md-1">
                                                <input type="text" name="book.fixedPrice" id="fixedPrice" class="form-control"/>
                                            </td>
                                            <td class="col-md-1">
                                                <input type="text" name="book.dangPrice" id="dangPrice" class="form-control"/>
                                            </td>
                                        </tr>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="col-md-1">
                                                <input type="number" name="book.whichEdtion" id="version" class="form-control"/>
                                            </td>
                                            <td class="col-md-2">
                                                <input type="text" name="book.isbn" id="isbn" class="form-control"/>
                                            </td>
                                            <td class="col-md-3">
                                                <input type="text" name="book.publishing" id="publish" class="form-control"/>
                                            </td>
                                            <td class="col-md-2">
                                                <input type="date" id="publis_time" class="form-control"/>
                                            </td>
                                            <td class="col-md-2">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="col-md-5">
                                                <input type="text" name="book.description" id="description"  class="form-control"/>
                                            </td>
                                            <td class="col-md-4">
                                                <input type="text" name="book.authorSummary" id="author_intro" class="form-control"/>
                                            </td>
                                            <td class="col-md-3">
