	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> <span class="little_n">
					| <a href="../cart/findAll.action?userId=${user.id }" name="mydangdang" class="head_black12a">我的西电</a> | <a
		...
		<b><s:property value="#session.user.nickname"/> 您好!欢迎光临西电购书系统</b>
		<s:if test="#session.user.nickname!=null">
		[&nbsp;<a href="../user/out.action" class="b">登出</a>&nbsp;]
		</s:if><s:else>
		[&nbsp;<a href="../user/login_form.jsp" class="b">登录</a>|<a
			href="../user/register_form.jsp" class="b">注册</a>&nbsp;]
		</s:else>
		<span style="color:black;font-size:15px"><s:property value="time"/></span>
		</span>
	</div>
